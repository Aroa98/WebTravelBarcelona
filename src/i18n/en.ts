export const en = {
  ...
  // Accommodation
  addAlojamiento: "Add accommodation",
  editAlojamiento: "Manage accommodation",
  alojamientoModalTitle: "Day Accommodation",
  alojamientoSelectTab: "Select existing",
  alojamientoCreateTab: "Create new",
  alojamientoNoneOption: "— No accommodation —",
  alojamientoSelectLabel: "Accommodation:",
  alojamientoLinkBtn: "Link",
  alojamientoNameLabel: "Accommodation name:",
  alojamientoNamePlaceholder: "e.g. Hotel Arts Barcelona",
  alojamientoUrlLabel: "Website / Booking (optional):",
  alojamientoUrlPlaceholder: "https://...",
  alojamientoAddressLabel: "Address (optional):",
  alojamientoAddressPlaceholder: "e.g. Carrer de la Marina, 19-21",
  alojamientoCreateBtn: "Create & Link",
  alojamientoSavingBtn: "Saving...",
  errorAlojamientoName: "Accommodation name is required.",
  errorAlojamientoSave: "Error saving accommodation.",
  editDayDescTooltip: "Edit day description",
  editDayDescTitle: "Edit Day Description",
  editDayDescLabel: "Day description (EN):",
  editDayDescPlaceholder: "e.g. Arrival and city center exploration",
  editDayDescSavingBtn: "Translating and saving...",
  errorSupabaseDayUpdate: "Error updating day description.",
