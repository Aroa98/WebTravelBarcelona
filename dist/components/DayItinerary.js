...
export class DayItinerary {
    ...
    onDaySelect;
    onUpdateDay;
    constructor(day, onDaySelect, onUpdateDay) {
        this.day = day;
    ...
    openAddPlanModal() {
        ...
        const createField = (label, isTextarea = false, placeholder = '', defaultValue = '') => {
        ...
        const timeInput = createField(t('modalTimeLabel'), false, '', '10:00:00');
        const titleInput = createField(t('modalActivityNameLabel'), false, t('modalActivityNamePlaceholder'));
        const descTextarea = createField(t('modalDescriptionLabel'), true, t('modalDescriptionPlaceholder'));
        const locInput = createField(t('modalLocationLabel'), false, t('modalLocationPlaceholder'));
        const linkInput = createField(t('modalBookingLinkLabel'), false, 'https://...');
